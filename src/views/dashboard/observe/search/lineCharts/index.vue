  ...
  mounted() {
    ...
    linechart.setOption({
      ...
      series: [
        {
          type: "line",
          data: [10, 22, 44, 22, 11, 34, 70, 29, 13, 22, 42, 21, 70, 23, 80],
          smooth: true,
          itemStyle: {
            opacity: 0,
          },
